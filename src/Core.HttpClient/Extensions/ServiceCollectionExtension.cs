...
namespace Core.HttpClient.Extensions
{
    ...
    public static class ServiceCollectionExtension
    {
            ...
            where TClient : class
        {
            ...
            return services
                .AddClientWithBaseHttpClient<TClient>(httpClientConfiguration.Name, baseHttpClientFactory)
        ...
        /// <summary>
        /// Registers a client of type <typeparamref name="TClient"/> with <see cref="IBaseHttpClient"/> dependency injected.
        /// </summary>
        /// <typeparam name="TClient">The client type to be registered.</typeparam>
        ...
        /// </returns>
        public static IServiceCollection AddClientWithBaseHttpClient<TClient>(
            this IServiceCollection services,
            ...
            where TClient : class
        {
            return services
                .AddTransient(sp =>
                {
                    ...
                    ObjectFactory factory = ActivatorUtilities.CreateFactory(typeof(TClient), [typeof(IBaseHttpClient),]);
                    return (TClient)factory(sp, [baseHttpClient]);
                });
        }
        ...
        private static BaseHttpClient CreateDefaultBaseHttpClient(IServiceProvider serviceProvider, string httpClientName)
        {
            ...
            return new BaseHttpClient(httpClient, httpContentFormatterFactory);
        }
    }
}
